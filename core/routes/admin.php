...
Route::middleware(['admin'])->group(function () {
    ...
    Route::controller('ReportController')->group(function () {
        ...
        Route::get('/user/transactions/{id}', 'userTransactions')->name('report.user.transactions');
    });
    ...
    // Pizza Items
    Route::controller('PizzaController')->name('pizza.')->prefix('pizzas')->group(function () {
        Route::get('', 'index')->name('index');
        ...
        Route::post('reviews/remove/{id}', 'reviewRemove')->name('review.remove');
    });
    ...
    Route::controller('ShippingMethodController')->name('shipping.')->prefix('shipping')->group(function () {
        Route::get('/index', 'index')->name('index');
        Route::post('/store/{id?}', 'store')->name('store');
    });
    ...
    Route::controller('ManageOrderController')->name('orders.')->prefix('orders')->group(function () {
        ...
        Route::post('/status/{id}', 'orderStatus')->name('status');
        Route::get('/invoice/{id}', 'invoice')->name('invoice');
        Route::get('/user/{id}', 'userOrders')->name('user');
    });
    // SEO
