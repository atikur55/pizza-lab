    ...
    Route::middleware(['check.status'])->group(function () {
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            ...
            Route::controller('UserController')->group(function () {
                ...
                //Report
                Route::get('payment/history', 'payments')->name('payments');
            ...
            Route::controller('CartController')->group(function () {
                ...
                Route::get('delete/cart', 'deleteCart')->name('delete-cart');
            });
            ...
            Route::controller('UserController')->name('order.')->prefix('order')->group(function () {
            ...
            Route::controller('ReviewController')->name('review.')->prefix('review')->group(function () {
                Route::get('pizzas', 'reviewPizzas')->name('pizzas');
                Route::get('create/{id}/{name}', 'reviewCreate')->name('create');
                Route::post('store/{id}', 'reviewStore')->name('store');
            });
        });
