...
@section('content')
@if ($layout == 'frontend')<section class="pt-80 pb-80"> @endif
    <div class="@if($layout == 'frontend') m-auto col-lg-8 @endif">
        <div class="card custom--card">
            <div class="card-header card-header-bg d-flex flex-wrap justify-content-between align-items-center">
                ...
                <button class="btn btn--danger close-button btn-sm decisionBtn" type="button" data-question="@lang('Are you sure to close this ticket?')" data-action="{{ route('ticket.close', $myTicket->id) }}"><i class="fa fa-lg fa-times-circle"></i>
                </button>
                @endif
            </div>
            <div class="card-body">
...
@if ($layout == 'frontend')</section> @endif
@endsection
@push('style')
    <style>
