                                ...
                                @forelse($reviews as $review)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="javascript:void(0)" class="btn btn-sm btn-outline--danger removeBtn" data-review_id="{{ $review->id }}">
...
@push('breadcrumb-plugins')
    <div class="d-flex flex-colum justify-content-end align-items-center flex-wrap gap-2">
        <a href="{{ route('admin.pizza.index') }}" class="btn btn-lg btn-outline--primary me-2"><i class="las la-undo"></i> @lang('Back')</a>
    </div>
@endpush
    ...
    <script>
        (function($) {
            ...
            $('.removeBtn').on('click', function() {
                ...
                modal.find('form').attr('action', `{{ route('admin.pizza.review.remove', '') }}/${$(this).data('review_id')}`);
                modal.modal('show');
            });
        })(jQuery);
    </script>
