                                        ...
                                        <div class="content w-100 ps-0">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="remove-btn">
                                                    <button type="button" class="btn btn--danger decisionBtn" data-question="@lang('Are you sure to delete this gateway currency?')" data-action="{{ route('admin.gateway.automatic.remove',$gatewayCurrency->id) }}">
