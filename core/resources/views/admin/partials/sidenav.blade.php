        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.category.index') }}">
                    <a href="{{ route('admin.category.index') }}" class="nav-link" data-default-url="{{ route('admin.category.index') }}">
                        <i class="menu-icon las la-sitemap"></i>
                        <span class="menu-title">@lang('Categories') </span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{ menuActive('admin.pizza.*') }}">
                    <a href="{{ route('admin.pizza.index') }}" class="nav-link" data-default-url="{{ route('admin.pizza.index') }}">
                        <i class="menu-icon las la-pizza-slice"></i>
                        <span class="menu-title">@lang('Pizzas') </span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{ menuActive('admin.coupon.index') }}">
                    <a href="{{ route('admin.coupon.index') }}" class="nav-link" data-default-url="{{ route('admin.coupon.index') }}">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.shipping.index') }}">
                    <a href="{{ route('admin.shipping.index') }}" class="nav-link" data-default-url="{{ route('admin.shipping.index') }}">
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.orders.pending') }}">
                                <a href="{{ route('admin.orders.pending') }}" class="nav-link">
                                    ...
                                    @if ($pending_order_count)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $pending_order_count }}</span>
                                    @endif
                                </a>
                            </li>
