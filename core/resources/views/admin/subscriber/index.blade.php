                                ...
                                @forelse($subscribers as $subscriber)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <button href="javascript:void(0)" class="btn btn-sm btn-outline--danger decisionBtn" data-question="@lang('Are you sure to remove this subscriber?')" data-action="{{ route('admin.subscriber.remove', $subscriber->id) }}">
