            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.deposit.reject')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <p>@lang('Are you sure to') <span class="fw-bold">@lang('reject')</span> <span class="fw-bold sale-amount text-success"></span> @lang('deposit of') <span class="fw-bold sale-user"></span>?</p>
    ...
    <script>
        (function ($) {
            ...
            $('.rejectBtn').on('click', function () {
                ...
                modal.find('.sale-amount').text($(this).data('amount'));
                modal.find('.sale-user').text($(this).data('username'));
                modal.modal('show');
            });
        })(jQuery);
    </script>
